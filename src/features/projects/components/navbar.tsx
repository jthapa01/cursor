              ...
              <BreadcrumbLink className="flex items-center gap-1.5" asChild>
                <Button variant="ghost" className="w-fit! p-1.5! h-7!" asChild>
                  <Link href="/">
                    ...
                    <span className={cn("text-sm font-medium", font.className)}>Cursor</span>
                  </Link>
                </Button>
              </BreadcrumbLink>
            </BreadcrumbItem>
        ...
        {project?.importStatus === "importing" ? (
          <Tooltip>
            <TooltipTrigger asChild>
              <LoaderIcon className="text-muted-foreground animate-spin h-4 w-4" />
            </TooltipTrigger>
            <TooltipContent><p>Importing...</p></TooltipContent>
          </Tooltip>
        ) : (
          <Tooltip>
            <TooltipTrigger asChild>
              <CloudCheckIcon className="text-muted-foreground h-4 w-4" />
            </TooltipTrigger>
            <TooltipContent>
              Saved{" "}
