...
const formSchema = z.object({
  repoName: z.string().min(1, "Repository name is required")
    ...
    .regex(/^[a-zA-Z0-9._-]+$/, "Repository name can only contain letters, numbers, hyphens, and underscores"),
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      try {
        ...
        console.log("Exporting project with values:", value);
            ...
            {(field) => {
              return (
                <Field>
                  ...
                  <Select value={field.state.value} onValueChange={(value: "public" | "private") => field.handleChange(value)}>
