  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="sm" className="h-full rounded-none" title="Preview Settings">
            ...
            <form.Field name="installCommand">
              {(field) => (
                <Field>
                  ...
                  />
                  <FieldDescription>The command to install dependencies</FieldDescription>
                </Field>
              )}
            </form.Field>
