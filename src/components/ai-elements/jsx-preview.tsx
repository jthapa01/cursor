...
export const JSXPreviewContent = memo(
  ({ className, ...props }: JSXPreviewContentProps) => {
    ...
    // The parser's last successful value is intentionally held outside React state.
    const displayJsx =
      // eslint-disable-next-line react-hooks/refs -- The ref stores the parser's last successful render.
